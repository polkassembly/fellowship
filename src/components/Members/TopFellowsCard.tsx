	...
	return (
		<>
			<LinkWithNetwork
				...
				className={`${className} hidden h-[52px] w-full items-center justify-between rounded-full bg-topFellowCardBg px-6 py-[6px] text-foreground md:flex`}
			>
			...
			<MemberCard
				...
				className='bg-topFellowCardBg md:hidden'
			/>
		</>
	);
}
