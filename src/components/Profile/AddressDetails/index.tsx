		...
		<>
			<div className='relative w-full md:w-auto'>
				<section className='relative h-full w-full xl:mb-auto xl:w-[98px]'>
					<Card className='bg-cardBg -top-5 z-10 mx-auto flex h-[98px] w-[98px] items-center justify-center rounded-full xl:absolute xl:-left-2 xl:-top-3'>
						<Identicon
				...
				<Card className='bg-cardBg relative flex h-[68px] min-w-[324px] gap-x-3 rounded-[20px] border border-primary_border pl-4 xl:pl-[98px]'>
